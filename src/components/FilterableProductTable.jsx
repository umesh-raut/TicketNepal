  ...
  function SearchBar({filterText, inStockOnly, onFilterTextChange, onInStockOnlyChange }){
    return(
      <form>
        ...
        <label>
          <input type='checkbox' onChange={(e)=>onInStockOnlyChange(e.target.value)}/>
          {''}
  ...
  function FilterableProductTable({ products }) {
    ...
    return (
      <div>
        ...
        <ProductTable products={products} filterText={filterText} inStockOnly={inStockOnly}  onFilterTextChange={setFilterText} onInStockOnlyChange={setInStockOnly}/>
      </div>
    );
  }
